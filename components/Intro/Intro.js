    ...
    <div className={styles.intro}>
      <article className={styles._first_intro}>
        <div className={styles._intro_data}>
          ...
          <p>
            ...
            Chameleons are stored as ERC-721 tokens on the Ethereum blockchain and hosted on IPFS. This collection will be followed by a 10k Chameleons avatars in the next few months.
          </p>
          <p>
      ...
      <article className={styles._second_intro}>
        ...
        <div className={styles._intro_data}>
          ...
          <ul>
            <li>
              First 3310 8-bit Chameleons will be free to mint. You will only need to pay the minting fees. Creator will set a 10% royalty fee for any resales that the holder might make, of which a 5% pool will be created and be 5% of the royalties will be distributed to the holders. Of the remaining 5%, we will donate 2.5% to an environmental impact charity and 2.5% will be used for the startup.
            </li>
            <li>
